...
complexity: Medium
depends_on: ["1.2"]
updated_at: 2026-05-14T21:16:13.576411Z
---
...
As a **NextLens operator**,
I want the system to **display clear, scannable status messages at each stage without reliance on color or animation**,
so that **I can follow progress in CI logs and terminal environments**.
...
Depends on: [Story 1.2](../stories/1.2-*.md)
