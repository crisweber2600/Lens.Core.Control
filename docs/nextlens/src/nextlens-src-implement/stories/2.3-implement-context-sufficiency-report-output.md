...
complexity: Medium
depends_on: ["1.3", "2.2"]
updated_at: 2026-05-14T21:16:13.577995Z
---
...
I want the system to **display sufficiency status in a clear, actionable format**,
so that **I can immediately understand what's missing and what to do next**.
...
Depends on: [Story 1.3](../stories/1.3-*.md), [Story 2.2](../stories/2.2-*.md)
