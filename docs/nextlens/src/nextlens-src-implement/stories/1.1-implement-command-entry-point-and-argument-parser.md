...
complexity: Medium
depends_on: []
updated_at: 2026-05-14T21:16:13.574899Z
---
...
I want the system to **accept command-line arguments for mode (new, doctor, salmon), context input source, and optional config overrides**,
so that **I can flexibly invoke different operational paths**.
