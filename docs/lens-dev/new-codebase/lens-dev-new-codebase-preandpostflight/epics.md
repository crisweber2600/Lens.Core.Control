...
key_decisions:
  ...
  - Treat the live target repo path `_bmad/lens-work/bmad-lens-preflight/` as the implementation authority, even where predecessor prose referenced older nesting.
  ...
  - Route mutable control and governance repo writes through `bmad-lens-git-orchestration` instead of ad hoc preflight git commands.
...
open_questions:
  - What exact new script name under `_bmad/lens-work/bmad-lens-preflight/scripts/` should own the full request-lifecycle entrypoint if the team decides not to reuse `preflight.py`?
depends_on:
  - business-plan.md
  - tech-plan.md
  - sprint-plan.md
...
| --- | --- | --- | --- | --- |
| Epic 1 | PF-1.1 | Cadence Split and Branch-Sensitive Refresh | Ready for Dev | `_bmad/lens-work/bmad-lens-preflight/SKILL.md`, `_bmad/lens-work/bmad-lens-preflight/scripts/light-preflight.py`, new lifecycle helpers under `_bmad/lens-work/bmad-lens-preflight/scripts/` |
| Epic 2 | PF-2.1 | Explicit Request Lifecycle Sync Policy | Ready for Dev | `_bmad/lens-work/bmad-lens-preflight/scripts/`, `_bmad/lens-work/bmad-lens-git-orchestration/SKILL.md`, `_bmad/lens-work/bmad-lens-git-orchestration/scripts/git-orchestration-ops.py` |
| Epic 3 | PF-3.1 | Validation Hardening and Readiness Handoff | Ready for Dev | `_bmad/lens-work/bmad-lens-preflight/scripts/tests/`, `_bmad/lens-work/bmad-lens-git-orchestration/scripts/tests/test-git-orchestration-ops.py`, preflight skill docs |
...
- Reconcile the planning packet with the live target repo layout under
  `_bmad/lens-work/bmad-lens-preflight/`.
...
- Align `bmad-lens-preflight/SKILL.md` and related notes with the live target repo paths
