...
| PP-1.2 | Write SKILL.md thin conductor contract | M | SKILL.md documents brainstorm-first ordering, batch delegation, review-ready delegation, no-governance-write invariant, phase completion gate, and all integration points | Contract must match the release SKILL.md behavioral specification without copying it verbatim |
| PP-1.3 | Add parity test skeletons | S | Tests fail red for brainstorm-first ordering, batch pass 1 stop, batch pass 2 resume, review-ready delegation, phase gate on fail, phase gate on pass, and no-governance-write invariant | Existing create-domain and init-feature tests must remain unchanged |
